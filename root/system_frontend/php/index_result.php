...
<body>
 ...
 <div class="nav">
      ...
      <div class="r-cards">
        <div class="left-col">
          ...
          <div class="r-buttons">
                      ...
                      <!-- Go back button (already in your code) -->
  ...
  <div id="pdf-report" style="display:none; font-family: Arial, sans-serif; color:#333;">
  ...
  <section style="padding:20px;">
    ...
    <table style="width:100%; border-collapse:collapse; margin-top:10px;">
      <thead style="background:#eee;">
        <tr>
          <th style="text-align:left; padding:8px;">Litter Type</th>
          <th style="text-align:left; padding:8px;">Total Count</th>
        </tr>
      </thead>
  ...
  <footer style="background:#f7f7f7; padding:10px; text-align:center; font-size:12px; color:#666;">
    Generated by LitterLens | Image-based Litter Detection System
  </footer>
</div>
